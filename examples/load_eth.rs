...
fn main() {
    ...
    let depth_display = eth_loader::load_depth_image(&Path::new(&depth_image_path), false, false);
    let gray_display = eth_loader::load_image_as_gray(&Path::new(&color_image_path), false, true);

    let depth_2_display = eth_loader::load_depth_image(&Path::new(&depth_2_image_path), false,false);
    let gray_2_display = eth_loader::load_image_as_gray(&Path::new(&color_2_image_path), false, true);
