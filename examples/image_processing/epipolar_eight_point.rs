...
fn main() -> Result<()> {
    ...
    let feature_matches = olsen_data.get_matches_between_images(s_idx, f_idx, invert_y, false);
    ...
    let (iso3_opt, _) = epipolar::tensor::decompose_essential_förstner(&essential_matrix,&feature_matches,&intensity_camera_1.get_inverse_projection(),&intensity_camera_2.get_inverse_projection());
