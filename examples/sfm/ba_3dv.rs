...
fn main() -> Result<()> {
    ...
    let ((cam_positions,points),(s,debug_states_serialized)) = run_ba(&filtered_matches_per_path, &sfm_config, &sfm_config, Some(&initial_cam_motions_per_path), (480,640), &runtime_parameters, 1.0,depth_prior);
