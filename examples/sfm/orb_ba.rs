...
use vision::sfm::{bundle_adjustment::run_ba,epipolar::tensor::BifocalType};
...
fn main() -> Result<()> {
    ...
    let sfm_config = SFMConfig::new(1, vec!(vec!(2)), camera_map.clone(), camera_map, vec!(all_matches), BifocalType::ESSENTIAL, 320*240);
