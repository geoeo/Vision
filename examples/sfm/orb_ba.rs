...
fn main() -> Result<()> {
    ...
    let sfm_config = SFMConfig::new(1, vec!(vec!(2)), camera_map.clone(), camera_map, vec!(all_matches), BifocalType::ESSENTIAL, Triangulation::LINEAR, true, 0.8, 5.0, 1.0, true, 320*240);
