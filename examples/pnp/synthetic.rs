...
use vision::numerics::{weighting, pose::from_matrix_3x4};
...
fn main() -> Result<()> {
    ...
    let (optimized_state, state_debug_list) = run_pnp::<_,{cam_extrinsic_intrinsic_state::CAMERA_PARAM_SIZE},cam_extrinsic_intrinsic_state::CameraExtrinsicIntrinsicState<Float,_>,_,Perspective<Float>,_>(&pnp_config,&runtime_parameters);
