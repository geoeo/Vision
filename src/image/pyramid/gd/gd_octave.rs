...
use crate::image::filter::{prewitt_kernel::PrewittKernel,gauss_kernel::GaussKernel1D,gaussian_2_d_convolution,filter_1d_convolution};
use crate::image::pyramid::gd::gd_runtime_parameters::GDRuntimeParameters;
...
impl GDOctave {
    ...
    pub fn build_octave(base_gray_image: &Image, sigma: Float, runtime_parameters: &GDRuntimeParameters) -> GDOctave {
        ...
        let gray_images: Vec<Image> = match runtime_parameters.use_blur {
            false => vec!(base_gray_image.clone()),
