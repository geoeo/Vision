...
pub trait Feature {
     ...
     */
    fn get_camera_ray(&self, inverse_intrinsics: &Matrix3<Float>, c: Float) -> Vector3<Float> {
        inverse_intrinsics*Vector3::<Float>::new(self.get_x_image_float(), self.get_y_image_float(),c)
    }
}
