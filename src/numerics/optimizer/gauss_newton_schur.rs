...
pub struct OptimizerGnSchur<F, C : Camera<F> + Copy, L: Landmark<F,LANDMARK_PARAM_SIZE> + Send + Sync, CP: CamState<F, C, CAMERA_PARAM_SIZE> + Send + Sync ,const LANDMARK_PARAM_SIZE: usize, const CAMERA_PARAM_SIZE: usize> where F: GenericFloat {
...
impl<F, C : Camera<F> + Copy, L: Landmark<F,LANDMARK_PARAM_SIZE> + Send + Sync,  CP: CamState<F, C, CAMERA_PARAM_SIZE> + Send + Sync, const LANDMARK_PARAM_SIZE: usize, const CAMERA_PARAM_SIZE: usize> OptimizerGnSchur<F,C,L,CP,LANDMARK_PARAM_SIZE, CAMERA_PARAM_SIZE> where F: GenericFloat {
