...
pub trait WeightingFunction<F : float::Float + Scalar + NumAssign + SimdRealField + ComplexField > {
...
impl<F> Debug for dyn WeightingFunction<F> where F : float::Float + Scalar + NumAssign + SimdRealField + ComplexField {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        write!(f, "{}", self.name())
    }
}

impl<F> Display for dyn WeightingFunction<F> where F : float::Float + Scalar + NumAssign + SimdRealField + ComplexField {
...
impl<F> WeightingFunction<F> for HuberWeight where F : float::Float + Scalar + NumAssign + SimdRealField + ComplexField + identities::One{
...
pub struct CauchyWeight<F> where F : float::Float + Scalar + NumAssign + SimdRealField + ComplexField + identities::One {
    pub c: F
}

impl<F> WeightingFunction<F> for CauchyWeight<F> where F : float::Float + Scalar + NumAssign + SimdRealField + ComplexField + identities::One{
...
impl<F> WeightingFunction<F> for BisquareWeight where F : float::Float + Scalar + NumAssign + SimdRealField + ComplexField + identities::One {
...
impl<F> WeightingFunction<F> for SquaredWeight where F : float::Float + Scalar + NumAssign + SimdRealField + ComplexField + identities::One {
