...
use na::{Vector3,Quaternion,UnitQuaternion, Isometry3, Translation3};
use crate::Float;
...
pub fn apply_pose_deltas_to_point(point: Vector3<Float>, pose_deltas: &Vec<Isometry3<Float>>) -> Vec<Vector3<Float>> {
