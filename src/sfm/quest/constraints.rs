...
pub fn generate_constraints(m1: &SMatrix<Float,3,5>, m2: &SMatrix<Float,3,5>) -> SMatrix<Float,10,35> {
    ...
    for i in 0..10 {
        a1[(0,i)] = coefs_n[(idx_bin_2[(0,i)],0)];
        a1[(10+i,i)] = coefs_d[(idx_bin_2[(0,i)],0)];
        a2[(0,i)] = coefs_n[(idx_bin_2[(0,i)],1)];
        a2[(10+i,i)] = coefs_d[(idx_bin_2[(0,i)],1)];
        a3[(0,i)] = coefs_n[(idx_bin_2[(0,i)],2)];
        a3[(10+i,i)] = coefs_d[(idx_bin_2[(0,i)],2)];
        a4[(0,i)] = coefs_n[(idx_bin_2[(0,i)],3)];
        a4[(10+i,i)] = coefs_d[(idx_bin_2[(0,i)],3)];
        a5[(0,i)] = coefs_n[(idx_bin_2[(0,i)],4)];
        a5[(10+i,i)] = coefs_d[(idx_bin_2[(0,i)],4)];
        a6[(0,i)] = coefs_n[(idx_bin_2[(0,i)],5)];
        a6[(10+i,i)] = coefs_d[(idx_bin_2[(0,i)],5)];
        a7[(0,i)] = coefs_n[(idx_bin_2[(0,i)],6)];
        a7[(10+i,i)] = coefs_d[(idx_bin_2[(0,i)],6)];
        a8[(0,i)] = coefs_n[(idx_bin_2[(0,i)],7)];
        a8[(10+i,i)] = coefs_d[(idx_bin_2[(0,i)],7)];
        a9[(0,i)] = coefs_n[(idx_bin_2[(0,i)],8)];
        a9[(10+i,i)] = coefs_d[(idx_bin_2[(0,i)],8)];
        a10[(0,i)] = coefs_n[(idx_bin_2[(0,i)],9)];
        a10[(10+i,i)] = coefs_d[(idx_bin_2[(0,i)],9)]; 
                
        b1[(0,i)] = coefs_n[(idx_bin_2[(1,i)],0)];
        b1[(10+i,i)] = coefs_d[(idx_bin_2[(1,i)],0)];
        b2[(0,i)] = coefs_n[(idx_bin_2[(1,i)],1)];
        b2[(10+i,i)] = coefs_d[(idx_bin_2[(1,i)],1)];
        b3[(0,i)] = coefs_n[(idx_bin_2[(1,i)],2)];
        b3[(10+i,i)] = coefs_d[(idx_bin_2[(1,i)],2)];
        b4[(0,i)] = coefs_n[(idx_bin_2[(1,i)],3)];
        b4[(10+i,i)] = coefs_d[(idx_bin_2[(1,i)],3)];
        b5[(0,i)] = coefs_n[(idx_bin_2[(1,i)],4)];
        b5[(10+i,i)] = coefs_d[(idx_bin_2[(1,i)],4)];
        b6[(0,i)] = coefs_n[(idx_bin_2[(1,i)],5)];
        b6[(10+i,i)] = coefs_d[(idx_bin_2[(1,i)],5)];
        b7[(0,i)] = coefs_n[(idx_bin_2[(1,i)],6)];
        b7[(10+i,i)] = coefs_d[(idx_bin_2[(1,i)],6)];
        b8[(0,i)] = coefs_n[(idx_bin_2[(1,i)],7)];
        b8[(10+i,i)] = coefs_d[(idx_bin_2[(1,i)],7)];
        b9[(0,i)] = coefs_n[(idx_bin_2[(1,i)],8)];
        b9[(10+i,i)] = coefs_d[(idx_bin_2[(1,i)],8)];
        b10[(0,i)] = coefs_n[(idx_bin_2[(1,i)],9)];
        b10[(10+i,i)] = coefs_d[(idx_bin_2[(1,i)],9)];  
    }
